...
namespace Exam.Web.Pages.ChallengeUserTotals
{
    ...
    {
        public double? TotalValueFilterMin { get; set; }

        public double? TotalValueFilterMax { get; set; }
        ...
        public IndexModel(IChallengeUserTotalsAppService challengeUserTotalsAppService)
        {
