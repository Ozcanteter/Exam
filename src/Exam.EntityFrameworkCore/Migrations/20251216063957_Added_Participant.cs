        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppParticipants_AbpUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppParticipants_AppChallenges_ChallengeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppParticipants_ChallengeId",
                table: "AppParticipants",
                column: "ChallengeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppParticipants_IdentityUserId",
                table: "AppParticipants",
